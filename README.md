...
|--------|------|----------|
| [v2.1.0](https://github.com/sevarus23/Mon_pub/releases/tag/v2.1.0) | 2026-04-05 | Scopus Import (XLSX/CSV), in_scopus маппинг по DOI/title, обновлённый ISSN-справочник (74k), фильтры OpenAlex |
